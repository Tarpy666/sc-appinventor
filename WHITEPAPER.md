...
**Fleet designation:** `sc-appinventor` · Part of the Counted fleet.

## Abstract

App Inventor kernel: designer view model, blocks editor, component properties. This repository ships a self-contained, deterministic implementation:
